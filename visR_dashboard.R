...
install.packages(setdiff(c("shiny", "shinydashboard", "plotly", "dplyr", "readr", "DT", "caret", "randomForest"), rownames(installed.packages())))
library(shiny)
...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(
      ...
      menuItem("Line Plot", tabName = "line", icon = icon("chart-line")),
      menuItem("Bar Plot", tabName = "bar", icon = icon("chart-bar")),
      menuItem("Donut Chart", tabName = "donut", icon = icon("chart-pie")),
      menuItem("Histogram", tabName = "histogram", icon = icon("chart-column")),
      menuItem("Violin Plot", tabName = "violin", icon = icon("guitar")),
      menuItem("Box Plot", tabName = "box", icon = icon("box")),
      menuItem("Heatmap", tabName = "heatmap", icon = icon("th")),
      menuItem("AI Analysis", tabName = "ai", icon = icon("robot"))
    )
  ),
  dashboardBody(
    tabItems(
      tabItem(tabName = "about",
                tags$div(
                  ...
                  tags$p("This is visR_dashboard, created using the `shinydashboard` package, which gives it a distinct appearance. It functions as a standalone application but does not support keyword arguments."),
                  ...
                  tags$h2("Usage"),
                  tags$p("To use visR, you can run it calling the visR function:"),
                  tags$pre("
# Run visR
visR()"),
                  
                  tags$h2("Installation"),
                  tags$p("To install and run visR, you need R and the required R packages, which will be installed by the app if they are not yet installed."),
                  tags$p("
Packages: shiny, shinydashboard, plotly, dplyr, readr, DT, caret, randomForest, bslib
      "),
                  tags$p("After installation, you can source the R script containing the visR function and run it as shown in the usage examples."),
                  ...
                  tags$p("Created with ❤️ by the visR team")
      )
      ),
      tabItem(tabName = "data",
              fluidRow(
                ...
                box(width = 12, title = "Column Type Information", status = "info", solidHeader = TRUE,
      ...
      tabItem(tabName = "scatter",
              fluidRow(
                box(width = 4, title = "Scatter Plot Options", status = "primary", solidHeader = TRUE,
                ...
                box(width = 8, title = "Scatter Plot", status = "info", solidHeader = TRUE,
      ...
      tabItem(tabName = "line",
              fluidRow(
                box(width = 4, title = "Line Plot Options", status = "primary", solidHeader = TRUE,
                ...
                box(width = 8, title = "Line Plot", status = "info", solidHeader = TRUE,
      ...
      tabItem(tabName = "bar",
              fluidRow(
                box(width = 4, title = "Bar Plot Options", status = "primary", solidHeader = TRUE,
                ...
                box(width = 8, title = "Bar Plot", status = "info", solidHeader = TRUE,
      ...
      tabItem("donut",
               fluidRow(
                 box(width = 4, title = "Donut Chart Options", status = "primary", solidHeader = TRUE,
                 ...
                 box(width = 8, title = "Donut Chart", status = "primary", solidHeader = TRUE,
      ...
      tabItem(tabName = "histogram",
              fluidRow(
                box(width = 4, title = "Histogram Options", status = "primary", solidHeader = TRUE,
                ...
                box(width = 8, title = "Histogram", status = "info", solidHeader = TRUE,
      ...
      tabItem(tabName = "violin",
              fluidRow(
                box(width = 4, title = "Violin Plot Options", status = "primary", solidHeader = TRUE,
                ...
                box(width = 8, title = "Violin Plot", status = "info", solidHeader = TRUE,
      ...
      tabItem(tabName = "box",
              fluidRow(
                box(width = 4, title = "Box Plot Options", status = "primary", solidHeader = TRUE,
                ...
                box(width = 8, title = "Box Plot", status = "info", solidHeader = TRUE,
      ...
      tabItem(tabName = "heatmap",
              fluidRow(
                box(width = 4, title = "Heatmap Options", status = "primary", solidHeader = TRUE,
                ...
                box(width = 8, title = "Heatmap", status = "info", solidHeader = TRUE,
      ...
      tabItem(tabName = "ai",
              fluidRow(
                box(width = 4, title = "AI Model Options", status = "primary", solidHeader = TRUE,
                ...
                box(width = 8, title = "Model Results", status = "info", solidHeader = TRUE,
...
server <- function(input, output, session) {
  ...
  output$box_plot <- renderPlotly({
    ...
    plot_ly(x = df$x, y = df$y, type = 'box',
            color = df$x, colors = generate_colors(length(unique(df$x)))) %>%
  ...
  output$model_plot <- renderPlotly({
    ...
    tryCatch({
      if(md$model_type %in% c("binary_classification", "multi_classification")) {
        ...
        print(paste("Target variable:", md$target))
        print(paste("Predictor variables:", paste(md$predictors, collapse=", ")))
        print(paste("Number of classes:", length(levels(df[[md$target]]))))
        ...
        print("Plotly object created successfully")
        return(p)
      } else {
